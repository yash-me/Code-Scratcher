  ...
  return (
    <footer className="footer-1 bg-light text-dark">
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-center">
          ...
          <Button color="dark" outline className="twitter btn-icon" href="https://twitter.com/bootstrapbay" target="_blank">
            <FontAwesomeIcon icon={['fab', 'twitter']} />
            <span className="sr-only">View our Twitter Profile</span>
          </Button>
          {" "}
          <Button color="dark" outline className="facebook btn-icon" href="https://www.facebook.com/bootstrapbayofficial/" target="_blank">
            <FontAwesomeIcon icon={['fab', 'facebook-square']} /> {" "}
            <span className="sr-only">View our Facebook Profile</span>
          </Button>
          {" "}
          <Button color="dark" outline className="github btn-icon" href="https://github.com/bootstrapbay" target="_blank">
